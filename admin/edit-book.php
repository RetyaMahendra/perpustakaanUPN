...
$sql="update  tblbooks 
    set BookName=:bookname,CatId=:category,AuthorId=:author,ISBNNumber=:isbn,BookPrice=:price, Total=Total+$tambah, tersedia=tersedia+$tambah where id=:bookid";
...
$_SESSION['msg']="Buku Berhasil Terupdate";
...
<div class="form-group">
<label> No ISBN <span style="color:red;">*</span></label>
<input class="form-control" type="text" name="isbn" value="<?php echo htmlentities($result->ISBNNumber);?>"  required="required" />
<p class="help-block">ISBN adalah International Standard Book Number</p>
</div>

<div class="form-group">
<label>Tambah Jumlah Buku<span style="color:red;">*</span></label>
<input class="form-control" type="number" name="tambah"  />
</div>


 <div class="form-group">
 <label>Harga Buku<span style="color:red;">*</span></label>
