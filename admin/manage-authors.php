...
$query -> execute();
$_SESSION['delmsg']="Pengarang Berhasil Dihapus";
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                          ...
                                          <a href="manage-authors.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('Yakin Untuk Dihapus?');"" >  <button class="btn btn-danger"><i class="fa fa-pencil"></i> Hapus</button>
                                            </td>
                                        </tr>
 <?php $cnt=$cnt+1;}} ?>                                      
                                    </tbody>
