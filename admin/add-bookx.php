...
$total=$_POST['total'];
$tersedia = $total; 
$sql="INSERT INTO  tblbooks(BookName,CatId,AuthorId,ISBNNumber,BookPrice,Total,tersedia) VALUES(:bookname,:category,:author,:isbn,:price,:total,:tersedia)";
...
{
$_SESSION['error']="Buku Gagal Ditambahkan, Coba lagi";
header('location:manage-books.php');
}
...
<input class="form-control" type="text" name="total"  required="required" autocomplete="off"  />
</div>

 <div class="form-group">
 <label>Harga Pinjam<span style="color:red;">*</span></label>
